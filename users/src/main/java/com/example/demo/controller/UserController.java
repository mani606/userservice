...
public class UserController {
	...
	public String getUserOrdersById(@PathVariable String userId) {
		...
		final String uri = "http://localhost:8090/demo/orders/" + userId;
		String result = restTemplate.getForObject(uri, String.class);
		return result;
	...
	public String getUserOrdersByReqParam(@RequestParam String userId) {
		...
		final String uri = "http://localhost:8090/demo/orders/byparam";
	...
	public String testPostWithParam(@RequestParam String userId) {

		String uri = "http://localhost:8090/demo/orders/byparam";
		HttpHeaders headers = new HttpHeaders();
	...
	public ResponseEntity<String> testReqBody() throws JSONException {
		...
		String uri = "http://localhost:8090/demo/orders/bybody";
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
